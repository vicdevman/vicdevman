...
export default function Footer() {
  ...
  return (
    <div className="text-center py-6 flex flex-col justify-center gap-6 max-sm:text-sm text-md text-neutral-500 font-[satoshi-medium] tracking-tight pt-10 border border-neutral-200 mt-10 mb-10 border-b-0">
      Copyright © {currentYear} Victor Adeiza. All rights reserved.
      <div className="flex mx-auto gap-6 text-center">
